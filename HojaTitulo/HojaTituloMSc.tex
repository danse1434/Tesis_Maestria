...
\includegraphics[scale=0.40]{HojaTitulo/Logo_Escudo}
\end{figure}
\thispagestyle{empty} \vspace*{0.28cm} \textbf{\huge
Farmacocinética poblacional en el manejo empírico de infecciones en pacientes con neoplasias hematológicas y neutropenia febril posquimioterapia}\\[4.0cm]
\Large\textbf{Daniel Sebastián Parra González}\\[5.0cm]
...
\begin{center}
\thispagestyle{empty} \vspace*{-1.00cm} \textbf{\huge
Farmacocinética poblacional en el manejo empírico de infecciones en pacientes con neoplasias hematológicas y neutropenia febril posquimioterapia}\\[3.0cm]
\Large\textbf{Daniel Sebastián Parra González}\\[2.0cm]
\small Tesis o trabajo de grado presentada(o) como requisito parcial para optar al título de:\\
\textbf{Magíster en Ciencias: Farmacología}\\[2.0cm]
Director(a):\\
Dr. Carlos Humberto Saavedra Trujillo \\
Dr. Jorge Augusto Díaz Rojas \\[1.8cm]
L\'{\i}nea de Investigaci\'{o}n:\\
Resistencia antimicrobiana\\
Grupo de Investigación:\\
Grupo de Investigación en Enfermedades Infecciosas\\[2.0cm]
